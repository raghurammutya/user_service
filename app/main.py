...
from app.api.endpoints import users, auth, groups, permissions, user_enhancements  # Your API routes
...
app.include_router(user_enhancements.router, prefix="/api/user-enhancements", tags=["user-enhancements"])
